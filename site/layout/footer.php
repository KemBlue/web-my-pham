                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-4 list">
                        <div class="footerLink">
                            ...
                            <ul class="list-unstyled">
                                ...
                                ?>
                                <li><a
                                        href="<?=$router->generate('category',['slug' => $slug , 'id' => $category->getId()])?>"><?= $category->getName()?></a>
                                </li>
                                <?php endforeach ?>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-4 list">
                        <div class="footerLink">
                            <h4>Liên kết </h4>
                            <ul class="list-unstyled">
                                <li><a href="<?=$router->generate('product')?>">Sản phẩm </a></li>
                                <li><a href="<?=$router->generate('return')?>">Chính sách đổi trả</a></li>
                                <li><a href="<?=$router->generate('payment')?>">Chính sách thanh toán</a></li>
                                <li><a href="<?=$router->generate('delivery')?>">Chính sách giao hàng </a></li>
                                <li><a href="<?=$router->generate('contact')?>">Liên hệ </a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-4 list">
                        <div class="footerLink">
                            ...
                            <ul class="list-unstyled">
                                <li>Phone: 0919.226.342</li>
                                <li><a href="mailto:qthien576@gmail.com">Mail:
                                        qthien576@gmail.com</a></li>
                            </ul>
...
<!-- Plugin chat code thuần -->
<?php require ABSPATH_SITE . 'layout/chatplugin.php' ?>
<!-- Plugin chat facebook không còn sử dụng được nữa -->
...
<!-- <div class="fb-customerchat" attribution=setup_tool page_id="108239495154355"
