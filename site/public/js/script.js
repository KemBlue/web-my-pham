...
// Kỹ thuật $funtion
// Toàn bộ code html tải hết rồi {...} mới chạy
$(function () {
  // Thay đổi province
  $("main .province").change(function (event) {
    /* Act on the event */ var province_id = $(this).val();
    if (!province_id) {
  ...
  $("main .district").change(function (event) {
    /* Act on the event */ var district_id = $(this).val();
    if (!district_id) {
      updateSelectBox(null, "main .ward");
      return;
    }
  ...
  $(".form-comment").validate({
    ...
    submitHandler: function (form) {
      ...
      $(".message").html(
        '<i class="fas fa-spinner fa-spin"></i> Hệ thống đang gởi đán giá, vui lòng chờ ...'
      );
